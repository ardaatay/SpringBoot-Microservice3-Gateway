...
public interface JWTProvidable {
    ...
    /**
     * @param request cozumlenip token uretilecek istek
     * @return son kullanma tarihi gecmisse false
     * aksi halde true
     * <p>
     * Detay:
    ...
    /**
     * @param request cozumlenip token uretilecek istek
     * @return kullanici ad, id ve rol bilgilerini iceren Authentication nesnesi
     * <p>
     * Detay:
    ...
    /**
     * @param authentication oturum acma isleminden sonra olusturulan UserPrinciple nesnesi
     * @return Kimligi dogrulanmis kullanicilarin kimlik bilgilerini (credentials)
