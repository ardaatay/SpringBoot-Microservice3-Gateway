...
public class RetrofitConfiguration
{
    ...
    {
        return createDefaultClientBuilder().addInterceptor(interceptor -> interceptor.proceed(
    ...
    private OkHttpClient.Builder createDefaultClientBuilder()
    {
        ...
        return new OkHttpClient.Builder().connectTimeout(TIMEOUT_IN_SECS, TimeUnit.SECONDS).readTimeout(TIMEOUT_IN_SECS,
                        TimeUnit.SECONDS) // TCP soket ve I/O operasyonlari icin varsayilan 10 saniye
                .writeTimeout(TIMEOUT_IN_SECS,
                        TimeUnit.SECONDS);  // istegi sunucuya yollarken, 2 veri paketi arasindaki iletisimsizlik süresi
